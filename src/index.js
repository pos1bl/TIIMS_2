...
// Візьмемо з таблиці значення t для 95% довірчих інтвервалів та вибірки ≈120 (в інтернеті не було знайдено значення 148)
const t = 1.980;

//Створюємо масив значень t для вибірки з 148 елементів та відповідним їм % довірчих інтервалів
//Тобто:
// t (20% і 148) = 0.254
// t (50% і 148) = 0.677
// t ...
...
//Отримаємо вибірки обягом 74, 37, 18, 9, 4, 2, 1
...
//Створюємо масив відповідних значень t для масиву різного обсягу вибірок і 95% довірчих інтвервалів
// Тобто:
// t (95% і 148) = 1.98
// t (95% і 74) = 2
// t ...
...
//Сортування вибірки, для зберігання її у форматі "key": value,
// де "key" - це значення у вибірці, а value - кількість цих значень
...
//Метод, щоб отримати доданки для кожної ітерації для формули обчислення вибіркової дисперсії
